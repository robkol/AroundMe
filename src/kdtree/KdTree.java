...
public class KdTree<T extends KdTree.XYZPoint> {
    ...
    public static class XYZPoint implements Comparable<XYZPoint> {
        ...
        public XYZPoint(double x, double y, String description){
        	this(x,y);
        ...
        public double euclideanDistance(XYZPoint o1) {
        	return latlongDistance(o1, this);
        ...
        private static final double latlongDistance(XYZPoint o1, XYZPoint o2) {
        	return LatLongUtils.distance(o1.y, o1.x, o2.y, o2.x);
        };
